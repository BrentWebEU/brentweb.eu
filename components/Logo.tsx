 ...
 * occupies x 237.4–879.5 / y 326.4–441.7 — roughly 8% of that canvas — so at a
 * 2rem nav height the wordmark rendered near-illegible, both as an <img> and
 * inline. Measured with getBBox(), plus ~2 units of breathing room.
 */
const VIEW_BOX = '235 324 647 120';
...
const PATHS: { d: string; tone: Tone }[] = [
  ...
  {
    tone: 'slogan',
    d: 'M802.6,438.1c-1.6.7-3.4,1-5.3,1-3,0-5.5-.8-7.7-2.4-2.1-1.6-3.6-3.7-4.3-6.4l24.7-4.8c-.2-2.6-.8-4.9-2-6.9s-2.9-3.7-4.9-4.9-4.3-1.8-6.8-1.8-5.2.7-7.3,1.9c-2.2,1.3-3.9,3-5.1,5.3-1.2,2.2-1.8,4.8-1.8,7.7s.6,5.4,1.9,7.7c1.3,2.2,3.1,4,5.4,5.3,2.3,1.3,4.9,1.9,7.8,1.9s4.3-.4,6.3-1.2c1.8-.8,3.5-2,4.8-3.6l-1.6-1.8c-1.1,1.4-2.5,2.4-4.1,3.1h0ZM790.5,415.9c1.7-1,3.7-1.6,5.9-1.6s3.7.4,5.3,1.3c1.6.8,2.8,2,3.8,3.4,1,1.5,1.6,3.1,1.8,4.8l-22.3,4.4c-.1-.7-.1-1.3-.1-1.7,0-2.3.4-4.4,1.5-6.3,1-1.8,2.3-3.3,4.1-4.3Z',
  },
  {
    tone: 'slogan',
    d: 'M879.5,412.1h-2.8v15.6c0,3.5-1,6.3-2.9,8.3-1.9,2.1-4.5,3.1-7.8,3.1s-5.4-.8-7.1-2.6c-1.7-1.7-2.5-4.2-2.5-7.5v-16.9h-2.8v17.1c0,4,1.1,7.1,3.2,9.2,2.1,2.1,5.2,3.2,9,3.2s4.8-.6,6.7-1.7c1.9-1.1,3.3-2.7,4.3-4.8v6.3h2.7v-29.2Z',
  },
];
